            ...
            <div className="space-y-12 sm:space-y-16">
              <div className="space-y-6 sm:space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-[10px] sm:text-xs font-black uppercase tracking-[0.4em] text-crimson">Featured Signal</h3>
                </div>
                ...
                <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-black text-foreground leading-[0.85] tracking-tighter uppercase">
                  SOUND FROM <br />
                  <span className="text-crimson drop-shadow-[0_0_20px_rgba(176,0,32,0.3)] italic">THE VOID</span>
                </h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
                <Link href="/story" className="inline-block group">
                    <span className="text-[10px] sm:text-xs font-black uppercase tracking-[0.4em] sm:tracking-[0.6em] text-crimson group-hover:text-foreground transition-colors">Lore Transmission 0.1</span>
                ...
                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-light italic leading-relaxed text-foreground/90 font-serif">
                   &quot;I am the ghost in your machine, the glitch in your heartbeat, the siren call from a future that never arrived.&quot;
                </h2>
